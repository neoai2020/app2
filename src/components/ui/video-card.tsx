        ...
        {isPlaying && videoUrl ? (
          ...
          <>
            ...
            <div className="absolute inset-0">
              <div className="absolute inset-0 bg-linear-to-br from-[#D946EF]/20 via-[#8B5CF6]/20 to-[#C026D3]/20" />
              <div className="absolute inset-0" style={{
                backgroundImage: 'radial-gradient(circle at 30% 50%, rgba(217, 70, 239, 0.15) 0%, transparent 50%), radial-gradient(circle at 70% 50%, rgba(139, 92, 246, 0.15) 0%, transparent 50%)'
              }} />
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              >
                ...
                <div className="absolute inset-0 -m-2">
                  <div className="absolute inset-0 rounded-full bg-[#D946EF]/30 animate-pulse" />
                </div>
                
                {/* Play button */}
                <div className="relative w-20 h-20 rounded-full bg-linear-to-br from-[#D946EF] to-[#8B5CF6] flex items-center justify-center shadow-2xl shadow-[#D946EF]/30 group-hover:shadow-[#D946EF]/50 transition-shadow">
            ...
            {/* Live indicator */}
            <div className="absolute top-4 left-4 flex items-center gap-2 px-3 py-1 bg-[#D946EF]/80 rounded text-xs text-white font-semibold">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          {!isPlaying && (
            <button
              onClick={() => videoUrl && setIsPlaying(true)}
              className="text-[#D946EF] text-sm font-semibold hover:text-[#e879f9] transition-colors flex items-center gap-1"
            >
              Watch Now
